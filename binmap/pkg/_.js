...
const BinMapFinalization = new FinalizationRegistry(ptr => wasm.__wbg_binmap_free(ptr));
/**
*/
class BinMap {
    ...
    static __wrap(ptr) {
        ...
        obj.ptr = ptr;
        BinMapFinalization.register(obj, obj.ptr, obj);
        return obj;
    }
    ...
    */
    set(key, val) {
        ...
        wasm.binmap_set(this.ptr, ptr0, len0, ptr1, len1);
    }
    /**
    * @param {Uint8Array} key
    ...
    */
    get(key) {
        try {
            ...
            const ptr0 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.binmap_get(retptr, this.ptr, ptr0, len0);
    ...
    */
    dump() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.binmap_dump(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
